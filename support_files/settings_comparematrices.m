function settings=settings_comparematrices(code_dir)
    %% Define the paths for support functions
    if ~exist('code_dir', 'var')
        str = computer;
        code_dir = pwd;
        ...
        try
            ...
            disp(['server_name is : ' server_name]);
        catch
            disp(['code dir is : ' code_dir]);
        ...
        switch server_name
            case '/code' %singularity container
                ...
                path_greyord_dscalar=path{12};
                path_greyord_dscalar_surface_only=path{8};
            ...
            case '/mnt/max/s' %rushmore
                ...
                path_greyord_dscalar=path{8};
                path_greyord_dscalar_surface_only='';
            ...
            case '/home/fair' %mesabi
                ...
                path_greyord_dscalar=path{8};
                path_greyord_dscalar_surface_only={12};
        ...
        cmtan_path=[code_dir, '/compare_matrices_to_assign_networks'];
        path{1}=cmtan_path;
        %templates:
        path{2}=[cmtan_path, '/support_files/Networks_template_cleaned.pscalar.nii'];
        path{3}=[cmtan_path, '/support_files/Networks_template_cleaned.pscalar.nii'];
        path{4}=[cmtan_path, '/support_files/120_LR_minsize400_recolored_manualconsensus4.dconn.nii'];
        path{5}=[cmtan_path, '/support_files/91282_Greyordinates.dscalar.nii'];
        path{6}=[cmtan_path, '/support_files/91282_Greyordinates.dtseries.nii'];
        path{7}=[cmtan_path, '/support_files/91282_Greyordinates_surf_only.dtseries.nii'];
        path{8}=[cmtan_path, '/support_files/91282_Greyordinates_surf_only.dscalar.nii'];
        path{9}=[code_dir, '/Zscore_dconn'];
        path{10}=[code_dir, '/cifti-matlab'];
        path{11}=[code_dir, '/matlab_GIfTI/@gifti'];
        path_wb_c='wb_command';
        path_template_nets=[cmtan_path, '/support_files/seedmaps_ABCD164template_SMOOTHED_dtseries_all_networksZscored.mat'];
        path_greyord_dscalar=path{5};
        path_greyord_dscalar_surface_only=path{8};
    end
    ...
    settings.path_greyord_dscalar=path_greyord_dscalar;
    settings.path_greyord_dscalar_surface_only=path_greyord_dscalar_surface_only;
